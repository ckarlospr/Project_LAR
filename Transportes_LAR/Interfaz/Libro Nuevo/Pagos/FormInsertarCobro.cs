...
{
	public partial class FormInsertarCobro : Form
	{
		public FormInsertarCobro(FormValidacionServicios valEsp, int tip)
		{
			InitializeComponent();
		...
		#region REFERENCIAS
		FormValidacionServicios formValidacion = null;
		private Proceso.AutoCompleClass auto= new Transportes_LAR.Proceso.AutoCompleClass();
		private Conexion_Servidor.SQL_Conexion conn= new Conexion_Servidor.SQL_Conexion();
		#endregion
		
		#region VALIDACION DE COMPONENTES
		private void getCargarValidacionCampos(FormInsertarCobro formDat)
		{
		...
		#region EVENTO LOAD		
		void FormInsertarCobroLoad(object sender, EventArgs e)
		{
